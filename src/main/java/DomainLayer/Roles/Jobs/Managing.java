...
public class Managing extends Job {
    ...
    public Managing(Store store, Ownership jobOfferer, int myID, boolean[] permissions) {
        ...
        this.permissions.put("addNewProduct", permissions[0]);
        this.permissions.put("changeProductQuantity", permissions[1]);
        this.permissions.put("changeProductPrice", permissions[2]);
        this.permissions.put("changeProductDescription", permissions[3]);
        this.permissions.put("removeProductFromInventory", permissions[4]);
    ...
    public void addNewProduct(String name, String description, int price, int quantity) {
        if (permissions.get("addNewProduct")) {
            super.addNewProduct(name, description, price, quantity);
        } else {
