...
public class JobService {
    ...
    public JobService(IJobRepository jobRepository, StoreService storeService) {
        this.JobRepository = jobRepository;
        this.storeService = storeService;
    }
    public void createStore(RegisteredUser founder) {
        Store createdStore = this.storeService.createStore();
